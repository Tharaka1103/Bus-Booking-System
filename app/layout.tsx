...
export default function RootLayout({
  ...
  const hideHeaderFooterRoutes = ['/login', '/booking', '/register', '/signin', '/signup', '/dashboard/manager', '/dashboard/admin', '/dashboard/super-admin', '/dashboard/users', '/dashboard/settings', '/dashboard/buses', '/dashboard/routes', '/dashboard/bookings', '/dashboard/bookings/create'];
